 ...
 * @LastEditTime: 2020-12-31 14:59:28
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \vscode-plugin-demo\vsc-extension-quickstart.md
-->
...
- `package.json` - 这是您声明扩展和命令的清单文件。
  ...
  VS Code 可以在命令面板中显示该命令。它还不需要加载插件。
...
- 在 Mac 上按（`Ctrl + Shift + P`或`Cmd + Shift + P`）并键入“Hello World”，从命令面板中运行命令。
...
- 您还可以使用扩展名重新加载（在 Mac 上为“Ctrl + R”或“Cmd + R”）VS Code 窗口以加载您的更改。

## 探索 API

- 当您打开文件`node_modules / vscode / vscode.d.ts`时，可以打开我们的全套 API。

## 运行测试

- 打开调试视图（在 Mac 上为“Ctrl + Shift + D”或“Cmd + Shift + D”），然后从启动配置下拉选择“启动测试”。
